...
public class DesktopPage extends Utils {
    private  By _clickOnSortByZToAOption =By.xpath("//select[@id=\"products-orderby\"]/option[3]");
    private By _verifyProductListedInZToAFormat =By.xpath("//div[contains(@class,'product-grid')]//div[@class='item-box']//h2");

    public void clickOnSortByZToAOption() {
        //Under sort by functionality, select "Name Z-A" option
        clickOnElement(_clickOnSortByZToAOption);
    }
    ...
    public void verifyProductListedInZToAFormat() {
        ...
        List<WebElement> elementList = driver.findElements(_verifyProductListedInZToAFormat); ////h2[@class='product-title']/a
